...
export const neighborhoods: Neighborhood[] = [
  ...
  },
  {
    ...
    population: "보통",
    subway: [],
    highlights: ["주거 중심", "금곡초 인근", "버스 교통", "조용한 동네"],
  },
  {
    id: "suwon-seryu",
    name: "세류동",
    ...
    population: "높음",
    subway: ["세류역"],
    highlights: ["세류역 도보", "수원역 인근", "상업지구", "교통 편리"],
  },
  {
    id: "suwon-gokban",
    name: "곡반정동",
    ...
    population: "보통",
    subway: [],
    highlights: ["주거 밀집", "학교 밀집", "조용한 편", "버스 교통"],
  },
  {
    id: "suwon-ipbuk",
    name: "입북동",
    ...
    population: "낮음",
    subway: [],
    highlights: ["자연환경", "신개발지", "조용한 주거지", "황구지천"],
  },
  {
    id: "suwon-pyeongdong",
    name: "평동",
    ...
    population: "낮음",
    subway: [],
    highlights: ["전원형 주거", "황구지천 인접", "신규 택지", "쾌적한 환경"],
  },
  // 수원 팔달구 추가
  {
    id: "suwon-gyo",
    ...
    population: "높음",
    subway: ["수원역"],
    highlights: ["수원역 역세권", "수원화성", "관광특구", "먹거리타운"],
  },
  {
    id: "suwon-jidong",
    name: "지동",
    ...
    population: "보통",
    subway: [],
    highlights: ["수원화성 인접", "지동시장", "구도심", "먹거리골목"],
  },
  // 수원 장안구 추가
  {
    id: "suwon-yeonseo",
    ...
    population: "높음",
    subway: [],
    highlights: ["북수원IC 인근", "학원가", "아파트 밀집", "수원천"],
  },
  {
    id: "suwon-songjuk",
    name: "송죽동",
    ...
    population: "보통",
    subway: [],
    highlights: ["주거 중심", "학교 밀집", "수원천 산책로", "버스 교통"],
  },
  // 수원 영통구 추가
  {
    id: "suwon-mangpo",
    ...
    population: "보통",
    subway: ["망포역"],
    highlights: ["신도시", "수인분당선", "신축 아파트", "학교 신설", "쾌적"],
  },
  {
    id: "suwon-woncheon",
    name: "원천동",
    ...
    population: "높음",
    subway: ["아주대입구역"],
    highlights: ["아주대 인근", "광교호수공원", "학원가", "수인분당선"],
  },
  ...
  // 가평군
  { id: "gapyeong-gapyeong", name: "가평읍", district: "가평군", city: "가평", lat: 37.8315, lng: 127.5098, noiseScore: 80, safetyScore: 65, convenienceScore: 50, overallScore: 62, population: "낮음", subway: ["가평역"], highlights: ["자라섬", "아침고요수목원", "관광지", "전원생활"] },
  { id: "gapyeong-cheongpyeong", name: "청평면", district: "가평군", city: "가평", lat: 37.7398, lng: 127.4266, noiseScore: 82, safetyScore: 63, convenienceScore: 45, overallScore: 60, population: "낮음", subway: ["청평역"], highlights: ["청평댐", "호명호수", "수변 생활", "레저 관광"] },
...
const complaintProfiles: Record<string, Record<string, [number, number]>> = {
  ...
  "suwon-geumgok":         { noise: [8, 16], parking: [8, 16], trash: [4, 10], road: [3, 7], construction: [4, 10], other: [2, 5] },
  "suwon-seryu":           { noise: [16, 30], parking: [14, 28], trash: [7, 16], road: [5, 10], construction: [6, 14], other: [3, 7] },
  "suwon-gokban":          { noise: [10, 20], parking: [8, 18], trash: [5, 12], road: [3, 7], construction: [4, 10], other: [2, 5] },
  "suwon-ipbuk":           { noise: [6, 14], parking: [6, 14], trash: [4, 8], road: [3, 7], construction: [6, 14], other: [2, 4] },
  "suwon-pyeongdong":      { noise: [5, 12], parking: [5, 12], trash: [3, 8], road: [2, 6], construction: [8, 18], other: [2, 4] },
  "suwon-gyo":             { noise: [22, 40], parking: [18, 35], trash: [10, 20], road: [5, 12], construction: [6, 14], other: [4, 8] },
  "suwon-jidong":          { noise: [18, 34], parking: [14, 28], trash: [8, 18], road: [4, 10], construction: [5, 12], other: [3, 7] },
  "suwon-yeonseo":         { noise: [14, 28], parking: [12, 24], trash: [6, 14], road: [4, 9], construction: [6, 14], other: [3, 6] },
  "suwon-songjuk":         { noise: [10, 20], parking: [8, 18], trash: [5, 12], road: [3, 7], construction: [4, 10], other: [2, 5] },
  "suwon-mangpo":          { noise: [6, 14], parking: [6, 14], trash: [4, 8], road: [3, 7], construction: [8, 18], other: [2, 5] },
  "suwon-woncheon":        { noise: [12, 24], parking: [10, 20], trash: [5, 12], road: [3, 8], construction: [6, 14], other: [3, 6] },
  // 성남 추가
  ...
  // 가평군
  "gapyeong-gapyeong":    { noise: [4, 10], parking: [4, 10], trash: [2, 6], road: [2, 5], construction: [2, 6], other: [1, 3] },
  "gapyeong-cheongpyeong": { noise: [3, 8], parking: [3, 8], trash: [2, 5], road: [2, 4], construction: [2, 5], other: [1, 3] },
  // 연천군
  "yeoncheon-yeoncheon":   { noise: [3, 8], parking: [3, 8], trash: [2, 6], road: [2, 5], construction: [2, 5], other: [1, 3] },
  "yeoncheon-jeongok":     { noise: [4, 10], parking: [4, 10], trash: [2, 6], road: [2, 5], construction: [2, 6], other: [1, 3] },
...
export const noisePoints: NoisePoint[] = [
  ...
  { id: "np-suwon-geumgok-1", lat: 37.2548, lng: 126.9643, level: 1, type: "other", description: "금곡동 주거지역 (조용한 편)" },
  { id: "np-suwon-seryu-1", lat: 37.2561, lng: 126.9898, level: 3, type: "traffic", description: "세류역 주변 교통량 높음" },
  { id: "np-suwon-gyo-1", lat: 37.2833, lng: 127.0153, level: 4, type: "nightlife", description: "수원역 먹자골목 야간 소음" },
  { id: "np-suwon-jidong-1", lat: 37.2795, lng: 127.0213, level: 3, type: "nightlife", description: "지동시장 야간 상권 소음" },
  { id: "np-suwon-yeonseo-1", lat: 37.3018, lng: 127.0168, level: 3, type: "traffic", description: "연무동 학원가 주변 교통 혼잡" },
  { id: "np-suwon-mangpo-1", lat: 37.2463, lng: 127.0653, level: 1, type: "construction", description: "망포역 인근 신축 공사 (일시적)" },
  { id: "np-suwon-woncheon-1", lat: 37.2778, lng: 127.0488, level: 2, type: "traffic", description: "아주대입구역 출퇴근 교통량" },
  // 성남 추가
...
export const reviews: AreaReview[] = [
  ...
  { id: "rv-suwon-geumgok-1", neighborhoodId: "suwon-geumgok", rating: 4, pros: "조용하고 아이 키우기 좋은 주거환경이에요", cons: "지하철이 없어서 차가 필수예요", livedYears: "3~5년", createdAt: "2024-11-15" },
  { id: "rv-suwon-geumgok-2", neighborhoodId: "suwon-geumgok", rating: 3, pros: "금곡초가 가까워 통학이 편해요", cons: "상권이 부족해서 멀리 나가야 해요", livedYears: "1~3년", createdAt: "2025-01-20" },
  { id: "rv-suwon-seryu-1", neighborhoodId: "suwon-seryu", rating: 3, pros: "세류역이 가깝고 수원역 접근이 좋아요", cons: "상업지구라 다소 시끄러워요", livedYears: "1~3년", createdAt: "2024-12-05" },
  { id: "rv-suwon-gokban-1", neighborhoodId: "suwon-gokban", rating: 4, pros: "학교가 가깝고 조용한 주거지역이에요", cons: "대중교통이 버스뿐이라 불편할 때도 있어요", livedYears: "3~5년", createdAt: "2025-02-08" },
  { id: "rv-suwon-ipbuk-1", neighborhoodId: "suwon-ipbuk", rating: 4, pros: "황구지천 산책로가 좋고 공기가 맑아요", cons: "편의시설이 멀어서 차가 없으면 불편해요", livedYears: "1~3년", createdAt: "2025-03-01" },
  { id: "rv-suwon-pyeongdong-1", neighborhoodId: "suwon-pyeongdong", rating: 4, pros: "전원적이고 신축 아파트가 들어서고 있어요", cons: "도심까지 거리가 있어 출퇴근 시간이 걸려요", livedYears: "1년 미만", createdAt: "2025-02-20" },
  { id: "rv-suwon-gyo-1", neighborhoodId: "suwon-gyo", rating: 3, pros: "수원역이 도보 거리고 수원화성 야경이 멋져요", cons: "관광지라 주말에 사람이 너무 많아요", livedYears: "1~3년", createdAt: "2024-11-25" },
  { id: "rv-suwon-jidong-1", neighborhoodId: "suwon-jidong", rating: 3, pros: "지동시장 먹거리가 다양하고 저렴해요", cons: "좁은 골목이 많고 야간에 소음이 있어요", livedYears: "1~3년", createdAt: "2025-01-10" },
  { id: "rv-suwon-yeonseo-1", neighborhoodId: "suwon-yeonseo", rating: 3, pros: "학원가가 가까워 아이 교육에 좋아요", cons: "학원 차량으로 저녁 교통이 혼잡해요", livedYears: "3~5년", createdAt: "2024-12-20" },
  { id: "rv-suwon-songjuk-1", neighborhoodId: "suwon-songjuk", rating: 4, pros: "수원천 산책로가 좋고 조용한 동네예요", cons: "대형마트가 멀어서 차로 이동해야 해요", livedYears: "1~3년", createdAt: "2025-01-28" },
  { id: "rv-suwon-mangpo-1", neighborhoodId: "suwon-mangpo", rating: 5, pros: "망포역 역세권에 신축 아파트가 많고 깨끗해요", cons: "출퇴근 시간 수인분당선이 혼잡해요", livedYears: "1~3년", createdAt: "2025-03-05" },
  { id: "rv-suwon-woncheon-1", neighborhoodId: "suwon-woncheon", rating: 4, pros: "광교호수공원 접근이 좋고 학원가가 발달했어요", cons: "아주대 주변 원룸 밀집으로 주차 경쟁이 있어요", livedYears: "1~3년", createdAt: "2025-02-15" },
...
export const safetyData: SafetyInfo[] = [
  ...
  { neighborhoodId: "suwon-geumgok", cctvCount: 22, cctvTraffic: 8, policeStation: "금곡파출소", policeDistance: "도보 8분", convenienceStores24h: 4, emergencyBells: 4, safetyScore: 74 },
  { neighborhoodId: "suwon-seryu", cctvCount: 30, cctvTraffic: 14, policeStation: "세류지구대", policeDistance: "도보 5분", convenienceStores24h: 7, emergencyBells: 5, safetyScore: 68 },
  { neighborhoodId: "suwon-gokban", cctvCount: 24, cctvTraffic: 10, policeStation: "권선지구대", policeDistance: "도보 10분", convenienceStores24h: 4, emergencyBells: 4, safetyScore: 72 },
  { neighborhoodId: "suwon-ipbuk", cctvCount: 20, cctvTraffic: 8, policeStation: "호매실파출소", policeDistance: "도보 12분", convenienceStores24h: 3, emergencyBells: 3, safetyScore: 73 },
  { neighborhoodId: "suwon-pyeongdong", cctvCount: 18, cctvTraffic: 6, policeStation: "호매실파출소", policeDistance: "도보 15분", convenienceStores24h: 2, emergencyBells: 3, safetyScore: 71 },
  { neighborhoodId: "suwon-gyo", cctvCount: 38, cctvTraffic: 18, policeStation: "수원중부경찰서", policeDistance: "도보 3분", convenienceStores24h: 12, emergencyBells: 8, safetyScore: 72 },
  { neighborhoodId: "suwon-jidong", cctvCount: 28, cctvTraffic: 12, policeStation: "팔달지구대", policeDistance: "도보 6분", convenienceStores24h: 6, emergencyBells: 5, safetyScore: 68 },
  { neighborhoodId: "suwon-yeonseo", cctvCount: 30, cctvTraffic: 14, policeStation: "장안지구대", policeDistance: "도보 6분", convenienceStores24h: 7, emergencyBells: 5, safetyScore: 71 },
  { neighborhoodId: "suwon-songjuk", cctvCount: 26, cctvTraffic: 10, policeStation: "장안지구대", policeDistance: "도보 8분", convenienceStores24h: 5, emergencyBells: 4, safetyScore: 73 },
  { neighborhoodId: "suwon-mangpo", cctvCount: 42, cctvTraffic: 18, policeStation: "망포파출소", policeDistance: "도보 5분", convenienceStores24h: 8, emergencyBells: 7, safetyScore: 80 },
  { neighborhoodId: "suwon-woncheon", cctvCount: 38, cctvTraffic: 16, policeStation: "영통지구대", policeDistance: "도보 5분", convenienceStores24h: 9, emergencyBells: 7, safetyScore: 78 },
  ...
  // 가평군
  { neighborhoodId: "gapyeong-gapyeong", cctvCount: 14, cctvTraffic: 6, policeStation: "가평경찰서", policeDistance: "도보 8분", convenienceStores24h: 3, emergencyBells: 2, safetyScore: 58 },
  { neighborhoodId: "gapyeong-cheongpyeong", cctvCount: 10, cctvTraffic: 4, policeStation: "청평파출소", policeDistance: "도보 10분", convenienceStores24h: 2, emergencyBells: 1, safetyScore: 54 },

  // 연천군
  { neighborhoodId: "yeoncheon-yeoncheon", cctvCount: 12, cctvTraffic: 5, policeStation: "연천경찰서", policeDistance: "도보 9분", convenienceStores24h: 2, emergencyBells: 2, safetyScore: 56 },
  { neighborhoodId: "yeoncheon-jeongok", cctvCount: 14, cctvTraffic: 6, policeStation: "전곡파출소", policeDistance: "도보 8분", convenienceStores24h: 3, emergencyBells: 2, safetyScore: 58 },
